								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">{{round(\App\invoices::where('Value_Status',1)->count()/\App\invoices::count())}} %</span>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">{{round(\App\invoices::where('Value_Status',2)->count()/\App\invoices::count())}} %</span>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7"> {{round(\App\invoices::where('Value_Status',3)->count()/\App\invoices::count())}} %</span>
										</span>
									</div>
								</div>
							</div>
