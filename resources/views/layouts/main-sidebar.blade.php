			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<li><a class="slide-item" href="{{ url('invoices/Partial') }}">الفواتير المدفوعة جزئيا</a></li>
						@endcan
						
						@can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ route('invoicesTrash') }}">ارشيف الفواتير</a></li>
							@endcan
						</ul>
					</li>
					@endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('invoicesReport') }}">تقارير الفواتير</a></li>
							<li><a class="slide-item" href="{{ url('invoicesCustomers') }}">تقرير العملاء</a></li>
						</ul>
					</li>
					@endcan
					@can('المستخدمين')
