                        ...
                        <table class="table text-md-nowrap text-center" id="example1">
                            ...
                            <tbody>
                                @foreach ($table_data as $invoice)
                                    <tr {{ ($invoice->Value_Status === 2) ? 'style=background-color:#b1f9bd61' : '' }}>
                                        <td>{{ $invoice->id }}</td>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge badge-pill badge-warning">مدفوع جزئيا</span>
                                            @endif
                                        </td>
                                        <td>{{ $invoice->note }}</td>
                                        <td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="modal-effect dropdown-item" data-effect="effect-scale" data-toggle="modal" href="#restore_invoice"><i class="text-danger typcn typcn-arrow-back-outline"></i>&nbsp;&nbsp; الغاءالحذف</a>
                                                </div>
                                            </div>
                                            {{-- dropdown --}}
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content tx-size-sm">
                                                <div class="modal-body tx-center pd-y-20 pd-x-20">
                                                    ...
                                                    <h4 class="tx-danger mg-b-20">هل انت متأكد من رغبتك في حذف الفاتورة
                                                        {{ $invoice->section_name }}</h4>
                                                    <p class="mg-b-20 mg-x-20">بمجرد حذف الفاتورة سيتم حذف محتوياتها ولن تتمكن
                                                        من استردادها</p>
                                                    <button aria-label="Close" class="btn ripple btn-success pd-x-25"
                                                        data-dismiss="modal" type="button">الغاء</button>
                                                    <a href="{{ url('delete_invoices/' . $invoice->id) }}"
                                            ...
                                            <div class="modal-content tx-size-sm">
                                                <div class="modal-body tx-center pd-y-20 pd-x-20">
                                                    <button aria-label="Close" class="close" data-dismiss="modal"
                                                        type="button"><span aria-hidden="true">&times;</span></button> <i
                                                        class="icon icon ion-ios-close-circle-outline tx-100 tx-danger lh-1 mg-t-20 d-inline-block"></i>
                                                    <h4 class="tx-danger mg-b-20">هل انت متأكد من رغبتك في اعادة الفاتورة
                                                        {{ $invoice->section_name }}</h4>
                                                    <p class="mg-b-20 mg-x-20">بمجرد اعادة الفاتورة سيتم اعادة محتوياتها </p>
                                                    <button aria-label="Close" class="btn ripple btn-success pd-x-25"
                                                        data-dismiss="modal" type="button">الغاء</button>
                                                    <a href="{{ url('restore_invoice/' . $invoice->id) }}"
                                                        class="btn ripple btn-danger pd-x-25">اعادة الفاتورة</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- End restore_invoice alert --}}
                                @endforeach
                            </tbody>
                        </table>
                    </div>
