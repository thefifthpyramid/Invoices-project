            ...
            <div class="card">
                ...
                <div class="card-header pb-15">
                    ...
                    <div class="col-sm-12 col-md-12 col-xl-12">
                        ...
                        <a class="btn btn-outline-primary" href="{{ url('exportInvoices') }}"><i class="fas fa-file-download"></i>&nbsp;تصدير اكسيل</a>
                    </div>
                </div>
                <!-- Add product Modal  -->
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="{{ url('PrintInvoice').'/'.$invoice->id }}"><i class="text-primary  fas fa-print"></i>&nbsp;&nbsp;طباعة الفاتورة</a>
